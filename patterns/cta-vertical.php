...
<div class="wp-block-group alignwide has-senary-background-color has-background">
	...
	<div class="wp-block-group">
		...
		<h2 class="has-text-align-center">Work With Us!</h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-buttons is-content-justification-center">
			...
			<div class="wp-block-button is-style-fill"><a class="wp-block-button__link">Send us an email</a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
