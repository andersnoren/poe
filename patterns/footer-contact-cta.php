<?php
/**
 * Title: Full width footer with contact details, call to action, site title, theme credit, and social icons.
 * Slug: poe/footer-contact-cta
	...
	<div class="wp-block-group alignfull has-quaternary-background-color has-background">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group alignwide">
				...
				<!-- wp:columns {"style":{"spacing":{"padding":{"bottom":"64px","top":"0px"}}}} -->
				<div class="wp-block-columns" style="padding-top:0px;padding-bottom:64px">
					<!-- wp:column -->
					<div class="wp-block-column">
						...
						<p class="has-medium-font-size">Poe Productions<br>Vasagatan 1<br>111 20 Stockholm</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:column -->
					...
					<div class="wp-block-column">
						...
						<!-- wp:paragraph {"fontSize":"medium"} -->
						<p class="has-medium-font-size">Poe Productions<br>Møllergata 4<br>0179 Oslo</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:column -->
					...
					<div class="wp-block-column">
						...
						<!-- wp:paragraph {"fontSize":"medium"} -->
						<p class="has-medium-font-size">Poe Productions<br>Rosengade 16<br>1309 Copenhagen</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:column -->
					...
					<div class="wp-block-column">
						...
						<!-- wp:paragraph {"fontSize":"medium"} -->
						<p class="has-medium-font-size">Poe Productions<br>Holtsgata 12<br>101 Reykjavik</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:column -->
				</div>
