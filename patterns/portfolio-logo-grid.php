<?php
/**
 * Title: Logo grid with a title and description.
 * Slug: poe/portfolio-logo-grid
...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns are-vertically-aligned-center" style="margin-bottom:32px">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			<!-- wp:heading {"level":4} -->
			<h4 id="our-clients">Our Clients</h4>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:column -->
	...
	<figure class="wp-block-gallery has-nested-images columns-6">
		...
		<figure class="wp-block-image"><img
				src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/illustrations/logo.png"
				alt="" /></figure>
		<!-- /wp:image -->
