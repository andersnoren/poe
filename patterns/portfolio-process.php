 ...
 * Slug: poe/portfolio-process
 * Categories: poe-portfolio
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"64px","bottom":"64px"}}},"backgroundColor":"quaternary","layout":{"inherit":true}} -->
<div class="wp-block-group alignfull has-quaternary-background-color has-background"
	...
	<div class="wp-block-group alignwide">
		<!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"bottom":"64px"}}}} -->
